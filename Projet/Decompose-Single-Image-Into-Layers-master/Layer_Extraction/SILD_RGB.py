...
#     L1_sumalpha=alphas.sum()/(alphas.shape[0]*alphas.shape[1]*alphas.shape[2])
#     output_txtfile=outprefix[:-10]+'alpha_info.txt'
#     myfile=open(output_txtfile,'a')
#     myfile.write(str(outprefix[-4:])+'  '+str(L1_sumalpha)+'\n')
#     myfile.close()
